...
class QueryParser(object):
    """
    Simple parser to allow users to be a bit sloppy with their queries and still
    get what they want.
    TODO: adapt this parser to the APIv4
    """
    ...
    def parse(self, **kwargs):
        ...
        # Nothing to do for 'segment' actually as it's too flexible to
...
class QueryParserV4(object):
    ...
    def parse(self, dev=True, **kwargs):
        """
        Check query structure to ensure formatting is valid
        """
        query = {}
        ...
        # temporarily return query as is to be able to run the code
        if dev:
            return query
